#!/usr/bin/env python3
"""
QB Model Inference Script - FIXED VERSION
Fixed fallback logic for backup QBs and better data handling
"""
...
def get_qb_features_from_master(master_row, current_season=2025, current_week=1, weekly_data=None):
    """Get QB features from master sheet data for prediction - FIXED VERSION."""
    ...
    try:
        ...
        if len(qb_data) == 0:
            ...
            print(f"  Using {len(recent_data)} recent games for {qb_name}")
...
def main():
    """Main function to run QB predictions - FIXED VERSION."""
    print("QB Model Inference Script - FIXED VERSION")
    print("Fixed fallback logic for backup QBs")
    print("=" * 60)
    ...
    if predictions is not None and len(predictions) > 0:
        print("\n" + "=" * 60)
        print("PREDICTIONS COMPLETE - FIXED VERSION")
        print("=" * 60)
        ...
        print("\n" + "=" * 60)
        print("TOP 10 QBs BY VALUE (pts/$1000)")
        print("=" * 60)
        ...
        print("\n" + "=" * 60)
        print("TOP 10 QBs BY PREDICTED POINTS")
        print("=" * 60)
